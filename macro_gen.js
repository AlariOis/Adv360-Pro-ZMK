...
macro_grave_force: macro_grave_force{
label = "macro_grave_force";
compatible = "zmk,behavior-macro";
#binding-cells = <0>;
...
macro_rshift_mo_6: macro_rshift_mo_6{
label = "macro_rshift_mo_6";
compatible = "zmk,behavior-macro";
#binding-cells = <0>;
wait-ms = <0>;
bindings
    = <&macro_press &mo 6 &kp RSHIFT>
    , <&macro_pause_for_release>
    , <&macro_release &mo 6 &kp RSHIFT>;
};
`;
